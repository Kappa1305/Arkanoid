                    ...
                    for ($j = 0; $j < 3; $j++) {
                        ...
                        if (in_array($skin, $sbloccati))
                            if ($skin == $skinSelezionata)
                                echo ('<td><img class = "skin selezionata" src="./immagini/ballskin' . $skin . '.PNG" ></a></td>');
                            else
                                echo ('<td><a href="ballskin.php?skin=' . $skin . '"><img  class = "skin sbloccata"  src="./immagini/ballskin' . $skin . '.PNG" ></a></td>');
                        else
